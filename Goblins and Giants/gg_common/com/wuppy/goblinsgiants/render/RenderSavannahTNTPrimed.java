...
public class RenderSavannahTNTPrimed extends RenderTNTPrimed
{
    private RenderBlocks blockRenderer = new RenderBlocks();

    public RenderSavannahTNTPrimed()
    {
        this.shadowSize = 0.5F;
    }

    public void renderPrimedTNT(EntitySavannahTNTPrimed par1EntityTNTPrimed, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderPrimedTNT((EntitySavannahTNTPrimed)par1Entity, par2, par4, par6, par8, par9);
    }
}
