...
public class RenderGoblin extends RenderLiving
{
    ...
    private ModelGoblin model;

    public RenderGoblin(ModelGoblin par1ModelBase, float par2, String string)
    {
    ...
    {
    	if(par1EntityLivingBase.getHeldItem() != null)
    		this.renderItems((EntityLiving)par1EntityLivingBase, par2);
    }
    
    protected void renderItems(EntityLiving par1EntityLiving, float par2)
    {
        float f1 = 1.0F;
        ...
        if (itemstack != null)
        {
            ...
            else if (item.isFull3D())
            {
                ...
                GL11.glTranslatef(0F, -0.125F, -0.2F);
                GL11.glScalef(f2, -f2, f2);
                GL11.glRotatef(-100.0F, 1.0F, 0.0F, 0.0F);
                GL11.glRotatef(45.0F, 0.0F, 1.0F, 0.0F);
            }
