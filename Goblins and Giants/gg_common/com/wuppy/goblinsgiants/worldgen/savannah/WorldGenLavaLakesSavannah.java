...
public class WorldGenLavaLakesSavannah extends WorldGenerator
{
    private Block block;

    public WorldGenLavaLakesSavannah(Block par1)
    {
        this.block = par1;
    }
                ...
                for (var32 = 0; var32 < 16; ++var32)
                {
                    for (var10 = 0; var10 < 8; ++var10)
                    {
                        ...
                        if (var33)
                        {
                            ...
                            if (var10 < 4 && !var12.isSolid() && par1World.getBlock(par3 + var8, par4 + var10, par5 + var32) != this.block)
                            {
                                return false;
                            }
                        }
            ...
            for (var8 = 0; var8 < 16; ++var8)
            {
                for (var32 = 0; var32 < 16; ++var32)
                {
                    for (var10 = 0; var10 < 8; ++var10)
                    {
                        ...
                        {
                            par1World.setBlock(par3 + var8, par4 + var10, par5 + var32, var10 >= 4 ? Blocks.air : this.block);
                        }
                    }
                }
            }
                ...
                for (var32 = 0; var32 < 16; ++var32)
                {
                    for (var10 = 4; var10 < 8; ++var10)
                    {
                        if (var6[(var8 * 16 + var32) * 8 + var10] && par1World.getBlock(par3 + var8, par4 + var10 - 1, par5 + var32) == Blocks.dirt && par1World.getSavedLightValue(EnumSkyBlock.Sky, par3 + var8, par4 + var10, par5 + var32) > 0)
                        {
                            ...
                            {
                                par1World.setBlock(par3 + var8, par4 + var10 - 1, par5 + var32, Blocks.mycelium);
                            }
                            else
                            {
                                par1World.setBlock(par3 + var8, par4 + var10 - 1, par5 + var32, Blocks.grass);
                            }
                        }
                    }
                }
