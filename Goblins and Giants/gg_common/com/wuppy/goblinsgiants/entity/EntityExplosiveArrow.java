...
public class EntityExplosiveArrow extends Entity implements IProjectile
{
    ...
    public EntityExplosiveArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityExplosiveArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityExplosiveArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityExplosiveArrow(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_)
    {
        super(p_i1756_1_);
        this.renderDistanceWeight = 10.0D;
	...
	public void onUpdate()
    {
        ...
        if (block.getMaterial() != Material.air)
        {
            ...
            worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 2 + rand.nextInt(5), true);
            this.setDead();
        }
