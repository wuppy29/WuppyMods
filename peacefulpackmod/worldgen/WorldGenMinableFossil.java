...
public class WorldGenMinableFossil extends WorldGenerator
{
    ...
    public WorldGenMinableFossil(int par1, int par2, int par3)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                {
                                    par1World.setBlock(var38, var41, var44, this.minableBlockId, this.metadata + par1World.rand.nextInt(3), 2);
                                }
                            }
                        }
                    }
