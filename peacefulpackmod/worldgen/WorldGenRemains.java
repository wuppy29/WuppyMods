...
public class WorldGenRemains extends WorldGenerator
{
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        for (int i = 0; i < 32; i++)
        {
            ...
            if (par1World.getBlockId(j, k, l) == Block.dirt.blockID && par1World.getBlockId(j, k + 1, l) == Block.grass.blockID)
            {
                par1World.setBlock(j, k, l, PeacefulPack.remains.blockID);
            }
        }
