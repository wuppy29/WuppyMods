...
public class RenderNetherEye extends Render
{
    private Item field_94151_a;
    private int field_94150_f;

    private static final ResourceLocation texture = new ResourceLocation(NetherEye.modid, "textures/items/nethereye.png");
    
    public RenderNetherEye(Item par1, int par2)
    {
        this.field_94151_a = par1;
        this.field_94150_f = par2;
    }

    public RenderNetherEye(Item par1)
    {
        this(par1, 0);
    }
