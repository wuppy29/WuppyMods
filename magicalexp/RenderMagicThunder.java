...
public class RenderMagicThunder extends Render
{
	private static final ResourceLocation texture = new ResourceLocation("assets/Wuppy29_MagicalExperience/textures/models/Thunder.png");
	
    public void renderArrow(EntityMagicThunder par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
