...
public class WorldGenSlimepool extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, BlockPos pos)
	{
		...
		if(world.getBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ())).getBlock().getMaterial().isSolid() == true && rand.nextInt(4) == 1)
		{
			world.setBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ()), block.getDefaultState(), 2);
			if(world.getBlockState(new BlockPos(pos.getX() + 1, pos.getY(), pos.getZ())).getBlock().getMaterial().isSolid() == true)
			{
			...
			if(world.getBlockState(new BlockPos(pos.getX(), pos.getY(), pos.getZ() + 1)).getBlock().getMaterial().isSolid() == true)
			{
			...
			if(world.getBlockState(new BlockPos(pos.getX() + 1, pos.getY(), pos.getZ() + 1)).getBlock().getMaterial().isSolid() == true)
			{
			...
			if(world.getBlockState(new BlockPos(pos.getX() + 2, pos.getY(), pos.getZ())).getBlock().getMaterial().isSolid() == true && world.getBlockState(new BlockPos(pos.getX() + 1, pos.getY(), pos.getZ())).getBlock() == block)
			{
