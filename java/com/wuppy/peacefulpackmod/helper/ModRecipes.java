...
public class ModRecipes {
	public static void init() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Items.gunpowder, 2), new ItemStack(ModItems.peacefulMaterial, 0), new ItemStack(ModItems.peacefulMaterial, 1), new ItemStack(Items.coal));
		GameRegistry.addShapelessRecipe(new ItemStack(Items.gunpowder, 2), new ItemStack(ModItems.peacefulMaterial, 0), new ItemStack(ModItems.peacefulMaterial, 1), new ItemStack(Items.coal, 1));
		GameRegistry.addRecipe(new ItemStack(Blocks.torch, 4), "X", "Z", 'X', ModItems.peacefulMaterial, 'Z', Items.stick);
		GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 2, 15), new ItemStack(Items.dye, 1, 15), new ItemStack(ModItems.peacefulMaterial, 1));
		GameRegistry.addShapelessRecipe(new ItemStack(Items.string, 2), new ItemStack(ModItems.peacefulMaterial, 2), new ItemStack(ModItems.peacefulMaterial, 2));
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.flaxSeed, 3), new ItemStack(ModItems.peacefulMaterial, 2));
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.wool, 1, 0), new ItemStack(ModItems.peacefulMaterial, 3), new ItemStack(ModItems.peacefulMaterial, 3));
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.peacefulMaterial, 3, 1), new ItemStack(Items.string), new ItemStack(Items.string));
		GameRegistry.addRecipe(new ItemStack(ModItems.peacefulMaterial, 4, 6), "XXX", "XXX", "XXX", 'X', Blocks.iron_bars);
		GameRegistry.addShapelessRecipe(new ItemStack(Items.book), new ItemStack(Items.paper), new ItemStack(Items.paper), new ItemStack(Items.paper), new ItemStack(ModItems.peacefulMaterial, 3));
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Items.writable_book, 1), new ItemStack(Items.book), new ItemStack(ModItems.peacefulMaterial, 1), new ItemStack(Items.feather));
	}
}