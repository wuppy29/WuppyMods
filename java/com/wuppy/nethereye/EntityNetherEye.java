...
public class EntityNetherEye extends Entity
{
	...
	public EntityNetherEye(World par1World)
	{
		super(par1World);
	...
	public EntityNetherEye(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.despawnTimer = 0;
		this.setSize(0.25F, 0.25F);
	...
	/**
	 * The location the eye should float/move towards. Currently used for moving towards the nearest stronghold. Args: strongholdX, strongholdY, strongholdZ
	 */
	...
	public void onUpdate()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			if (this.despawnTimer > 80 && !this.worldObj.isRemote)
			{
				...
				{
					this.worldObj.spawnEntityInWorld(new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, new ItemStack(NetherEye.nethereye)));
				} else
				{
