...
public class SimplePack
{
	...
	public void load(FMLInitializationEvent event)
	{
		...
		if (craftArrow)
		{
			GameRegistry.addRecipe(new ItemStack(Items.arrow, 2), "XCX", " V ", " B ", 'X', Blocks.leaves, 'C', Items.string, 'V', Items.stick, 'B', Items.flint);
		}
		if (craftString)
		{
		...
		if (craftLead)
		{
			GameRegistry.addRecipe(new ItemStack(Items.lead), "X ", "X ", "XY", 'X', Items.leather, 'Y', Items.string);
			GameRegistry.addRecipe(new ItemStack(Items.lead), " X", " X", "YX", 'X', Items.leather, 'Y', Items.string);
		}
		if (craftSaddle)
		{
			GameRegistry.addRecipe(new ItemStack(Items.saddle), "XYX", "X X", "X X", 'X', Items.leather, 'Y', Items.iron_ingot);
		}
		if (craftGrass2)
		{
