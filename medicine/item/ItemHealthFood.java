...
public class ItemHealthFood extends ItemFood
{
    ...
    public ItemHealthFood(int par1, int par2, float par3, boolean par4)
    {
	...
	{
		this.itemIcon = par1IconRegister.registerIcon(Medicine.modid + ":" + (this.getUnlocalizedName().substring(5)));
	}

    public ItemHealthFood(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemHealthFood setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
    ...
    public ItemHealthFood setSecondPotionEffect(int par1, int par2, int par3, float par4)
    {
    	this.potionId2 = par1;
     ...
     */
    public ItemHealthFood setAlwaysEdible()
    {
