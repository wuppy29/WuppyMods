...
{
	private static final ResourceLocation texture = new ResourceLocation("textures/models/bonespear.png");
	
    public void renderSpear(EntityBoneSpear par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
