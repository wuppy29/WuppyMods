...
public class EntityRedCreeper extends EntityMob
{
    ...
    public void onLivingUpdate()
    {
    	...
    	{
    		if (this.isWet() || this.worldObj.getBlock(serverPosX, serverPosY, serverPosZ) == Blocks.water || this.worldObj.getBlock(serverPosX, serverPosY, serverPosZ) == Blocks.flowing_water)
            {
        ...
        if (this.isEntityAlive())
        {
            ...
            if (this.timeSinceIgnited >= this.fuseTime)
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    ...
                    this.worldObj.setBlock((int) (this.posX), (int) (this.posY - 4), (int) (this.posZ), Blocks.flowing_lava);
