...
public class WorldGenMinablePeacefulDirt extends WorldGenerator
{
    ...
    public WorldGenMinablePeacefulDirt(Block par1, int par2, int par3)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && par1World.getBlock(var38, var41, var44) == Blocks.dirt)
                                {
                                    par1World.setBlock(var38, var41, var44, this.minableBlock, this.metadata, 2);
                                }
                            }
                        }
                    }
