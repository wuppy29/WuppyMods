...
public class ItemGoblinFood extends ItemFood
{
	...
	public ItemGoblinFood(int par1, int par2, float par3, boolean par4)
	{
	...
	public ItemGoblinFood(int par1, int par2, boolean par3)
	{
	 ...
	 */
	public ItemGoblinFood setPotionEffect(int par1, int par2, int par3, float par4)
	{
		this.potionId = par1;
	 ...
	 */
	public ItemGoblinFood setAlwaysEdible()
	{
