...
public class ItemIronPoisonSword extends Item
{
    ...
    public ItemIronPoisonSword(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
        super(par1);
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        {
        	par3EntityLivingBase.dropItem(Item.swordIron.itemID, 1);
        	par1ItemStack.damageItem(1, par3EntityLivingBase);
        }
