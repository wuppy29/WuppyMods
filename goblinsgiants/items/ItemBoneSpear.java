...
public class ItemBoneSpear extends Item
{
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
	{
		...
		if (var5 || par3EntityPlayer.inventory.hasItem(GoblinGiant.bonespear.itemID))
		{
			...
			{
				par3EntityPlayer.inventory.consumeInventoryItem(GoblinGiant.bonespear.itemID);
			}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(GoblinGiant.bonespear.itemID))
		{
