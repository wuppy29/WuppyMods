...
public class GoblinGiant
{
	...
	public void load(FMLInitializationEvent event)
	{
		...
		// bonespear
		GameRegistry.addShapelessRecipe(new ItemStack(component, 1, 3), new Object[]
			{
				new ItemStack(component, 1, 0), new ItemStack(component, 1, 2)
			});

		GameRegistry.addRecipe(new ItemStack(bonespear, 8), new Object[]
			{
				"X", "Z", "C", 'X', new ItemStack(component, 1, 1), 'Z', new ItemStack(component, 1, 3), 'C', Item.feather
			});

		// Poison swords and bottles
		GameRegistry.addShapelessRecipe(new ItemStack(component, 2, 4), new Object[]
			{
				new ItemStack(Item.spiderEye), new ItemStack(Item.potion, 1, 0), new ItemStack(component, 1, 0)
			});

		GameRegistry.addRecipe(new ItemStack(savannahtnt), new Object[]
			{
				"XCX", "CXC", "XCX", 'X', Block.sand, 'C', new ItemStack(component, 1, 5)
			});
