...
public class RenderExplosiveArrow extends Render
{
    ...
    public void renderArrow(EntityExplosiveArrow par1EntityExplosiveArrow, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        GL11.glRotatef(par1EntityExplosiveArrow.prevRotationPitch + (par1EntityExplosiveArrow.rotationPitch - par1EntityExplosiveArrow.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
        ...
        float f11 = (float)par1EntityExplosiveArrow.arrowShake - par9;
