...
import goblinsgiants.worldgen.WorldGenLavaTrap;
import goblinsgiants.worldgen.WorldGenMinableSandstone;
import goblinsgiants.worldgen.WorldGenRedCactus;
import goblinsgiants.worldgen.savannah.WorldGenEmptyTemple;
import goblinsgiants.worldgen.savannah.WorldGenLavaLakesSavannah;
import goblinsgiants.worldgen.savannah.WorldGenSavWell;
import goblinsgiants.worldgen.savannah.WorldGenSavannahTree;
...
public class ChunkProviderSavannah implements IChunkProvider
{
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, var11, LAVA) && !var11 && this.rand.nextInt(4) == 0)
		{
			...
			{
				(new WorldGenLavaLakesSavannah(Block.lavaStill.blockID)).generate(this.worldObj, this.rand, var12, var13, var14);
			}
		}
