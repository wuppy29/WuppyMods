...
public class ComponentMineshaftRoomSavannah extends StructureComponent
{
    ...
    public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
    {
        ...
        for (var5 = 0; var5 < this.boundingBox.getXSize(); var5 += 4)
        {
            ...
            var7 = StructureMineshaftPiecesSavannah.getNextComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + var5, this.boundingBox.minY + par3Random.nextInt(var6) + 1, this.boundingBox.minZ - 1, 2, var4);
        ...
        for (var5 = 0; var5 < this.boundingBox.getXSize(); var5 += 4)
        {
            ...
            var7 = StructureMineshaftPiecesSavannah.getNextComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX + var5, this.boundingBox.minY + par3Random.nextInt(var6) + 1, this.boundingBox.maxZ + 1, 0, var4);
        ...
        for (var5 = 0; var5 < this.boundingBox.getZSize(); var5 += 4)
        {
            ...
            var7 = StructureMineshaftPiecesSavannah.getNextComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.minY + par3Random.nextInt(var6) + 1, this.boundingBox.minZ + var5, 1, var4);
        ...
        for (var5 = 0; var5 < this.boundingBox.getZSize(); var5 += 4)
        {
            ...
            var7 = StructureMineshaftPiecesSavannah.getNextComponent(par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.minY + par3Random.nextInt(var6) + 1, this.boundingBox.minZ + var5, 3, var4);
