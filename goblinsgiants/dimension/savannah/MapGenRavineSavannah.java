...
public class MapGenRavineSavannah extends MapGenBase
{
                                ...
                                if (var59 * var59 + var45 * var45 < 1.0D)
                                {
                                    for (int var49 = var37 - 1; var49 >= var55; --var49)
                                    {
                                        ...
                                        if ((var59 * var59 + var45 * var45) * (double)this.field_75046_d[var49] + var50 * var50 / 6.0D < 1.0D)
                                        {
                                            ...
                                            if (var52 == Block.stone.blockID || var52 == Block.dirt.blockID || var52 == Block.grass.blockID || var52 == Block.sandStone.blockID || var52 == Block.sand.blockID)
                                            {
                                                if (var49 < 10)
                                                {
