...
public class EntityExplosiveArrow extends Entity
{
    ...
    public EntityExplosiveArrow(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public EntityExplosiveArrow(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
