...
public class EntityRedCreeper extends EntityMob
{
    /**
    ...
    public EntityRedCreeper(World par1World)
    {
        super(par1World);
    ...
    public void onLivingUpdate()
    {
    	...
    	{
    		if (this.isWet() || this.worldObj.getBlockId(serverPosX, serverPosY, serverPosZ) == Block.waterStill.blockID || this.worldObj.getBlockId(serverPosX, serverPosY, serverPosZ) == Block.waterMoving.blockID)
            {
        ...
        if (this.isEntityAlive())
        {
            ...
            if (this.timeSinceIgnited >= this.fuseTime)
            {
                ...
                if (!this.worldObj.isRemote)
                {
                    ...
                    this.worldObj.setBlock((int) (this.posX), (int) (this.posY - 4), (int) (this.posZ), Block.lavaMoving.blockID);
